...
export default function SuperadminLayout({ children }) {
  ...
  const menuItems = [
    ...
    { name: 'All Appointments', path: '/superadmin-appointments', icon: <CalendarDays size={18} /> },
    { name: 'Manage Users', path: '/superadmin-users', icon: <Users size={18} /> },
    { name: 'Reports', path: '/superadmin-reports', icon: <BarChart3 size={18} /> },
            ...
            <div className="profile-menu" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div className="dropdown">
                   <button onClick={() => navigate('/superadmin-profile')}>View Profile</button>
